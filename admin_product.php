...
<div class="mt-[1%] lg:flex justify-end lg:h-10 h-10">
    <form class="lg:w-1/3  lg:flex justify-evenly items-center">
        <label for="search">
            Select Category :
        </label>
        ...
        <thead>
            <tr>
                <th
                    ...
                    <p
                        class="antialiased font-sans text-sm  flex items-center justify-between gap-2  leading-none font-bold">
                        Product Id
                    </p>
                </th>
                <th
