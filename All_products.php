...
<body>
    ...
    <form action="#" method="post" enctype="multipart/form-data">
        <div class="max-w-[1320] mx-auto grid lg:grid-cols-4 md:grid-cols-2 gap-6 px-[20px] w-full h-auto mt-3">

            <?php
            while ($row = mysqli_fetch_assoc($result)) {
                ?>

                <div class="text-center shadow-lg h-fit overflow-hidden shadow-gray-200" onclick="window.location.href = 'product_detail.php?pid=<?php echo $row['pid']?>'">
                    ...
                    <div class="h-[15%]">
                        <h3 class="py-2 text-xl truncate font-normal">
                            <?php echo $row["pname"]; ?>
                        </h3>
                        <p class="py-2">
                    ...
                    <!-- <div>
                <button class="w-1/1 p-2  bg-blue-700 hover:bg-blue-500 text-white">Add to cart</button>
            </div> -->
                </div>
