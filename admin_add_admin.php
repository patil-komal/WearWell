...
<div class="min-w-screen  bg-gray-700 flex items-center justify-center px-5 py-5">
    <div class="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden" style="max-width:1000px">
        <div class="md:flex w-full">
            ...
            <form method="post">
            <div class="w-full md:w-1/2 py-10 px-5 md:px-10 bg-gray-800">
                <div class="text-center mb-10">
                    <h1 class="font-bold text-3xl text-white">ADD ADMIN</h1>
                    <p>Enter Admin information to register</p>
                </div>
                <div>
                    <div class="flex -mx-3">
                        <div class="w-full px-3 mb-5">
                            <label for="" class="text-xs font-semibold text-white px-1">USERNAME</label>
                            <div class="flex">
                                <div
                                    class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                                    <i class="mdi mdi-account-outline text-gray-400 text-lg"></i></div>
                                <input type="text"
                                    class="w-full -ml-10 pl-10 pr-3 py-2 bg-gray-700 rounded-lg border-2 border-gray-400 text-white outline-none focus:border-white"
                    ...
                    <div class="flex -mx-3">
                        <div class="w-full px-3 mb-5">
                            <label for="" class="text-xs font-semibold text-white px-1">EMAIL</label>
                            <div class="flex">
                                <div
                                    class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                    ...
                    <div class="flex -mx-3">
                        <div class="w-full px-3 mb-12">
                            <label for="" class="text-xs font-semibold text-white px-1">PASSWORD</label>
                            <div class="flex">
                                <div
                                    class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                    ...
                    <div class="flex -mx-3">
                        <div class="w-full px-3 mb-5">
                            <button name="addadmin" type="submit"
                                class="block w-full max-w-xs mx-auto bg-gray-500 hover:bg-gray-700 focus:bg-indigo-700 text-black hover:text-white rounded-lg px-3 py-3 font-semibold">ADD
                                </button>
                        </div>
                    </div>
                </div>
...
<?php 
    if (isset($_POST['addadmin'])) {
       ...
       $addadminquery = "INSERT INTO `admin`(`username`, `email`, `password`) VALUES ('$uname','$email','$password')";
       ...
       if ($addadminresult) {
        ...
        <?php
        echo "<script>
        window.location.href = 'Dashboard.php?addadmin=true'</script>";
       }
    }
?>